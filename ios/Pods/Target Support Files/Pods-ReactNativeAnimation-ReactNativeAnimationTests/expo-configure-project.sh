...
with_node \
  ...
  --target "/Users/guestguest/Desktop/react-native-animation/season1/ios/Pods/Target Support Files/Pods-ReactNativeAnimation-ReactNativeAnimationTests/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-gl" "expo-keep-awake"
